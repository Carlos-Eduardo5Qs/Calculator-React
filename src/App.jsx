    ...
    <div className="App">
      <div id="container">
        ...
        <table>
          <tbody>
            <tr>
              <td colSpan={2}><button value="CLEAR" onClick={clearScreen}>CLEAR</button></td>
              <td><button value="DEL" onClick={deleteDigt}>DEL</button></td>
            ...
            <tr>
              ...
              <td><button value="." onClick={handleClick}>.</button></td>
              <td colSpan={2}><button value="=" onClick={calculate}>=</button></td>
            </tr>
          </tbody>
        </table>
      </div>
